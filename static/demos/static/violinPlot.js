...
let yEnc = msc.encode(setose.topLeftVertex, {channel: "y", attribute: "sepal_length"});
msc.encode(setose.topRightVertex, {channel: "y", attribute: "sepal_length", shareScale: yEnc});
let wdEnc = msc.encode(setose, {channel: "width", attribute: "sepal_length_density"});
