...
let xEnc = msc.encode(rect, {attribute: "Draft_Year", channel: "x", rangeExtent: 910});
let yEnc = msc.encode(rect, {attribute: "Draft_Pick", channel: "y", flipScale: true, rangeExtent: 500});

let mapping = {"-20": "#d7d7d7", "-10": "#ecdba7", "20": "#b87187", "50": "#9d326a"};
let fillEnc = msc.encode(rect, {attribute: "VORP", channel: "fillColor", mapping: mapping});
