...
// msc.repopulate(bars, dt2, {"Task":"date"});
// let enc1 = msc.encode(rect.leftSegment, {attribute: "minTemp", channel: "x"});
// msc.encode(rect.rightSegment, {attribute: "maxTemp", channel: "x", shareScale: enc1});
// msc.update(rect, {"height": 5});
