...
let enc = msc.encode(rect, {attribute: "% Change", channel: "height"});
...
// msc.repopulate(years, dt2, {"Year":"Country_Code", "Quarter":"Medal_Type"});
// msc.encode(rect, {attribute: "Count", channel: "height"});
// msc.encode(rect, {attribute: "Medal_Type", channel: "fillColor"});
