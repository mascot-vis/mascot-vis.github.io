...
let xEnc = msc.encode(bgArea.anyVertex, "x", "date");
let hEnc = msc.encode(bgArea, "height", "price");
scene.axis("x", "date", { orientation: "bottom", element: bgArea.anyVertex, labelFormat: "%Y", titleVisible: false });
...
msc.encode(overlayArea.anyVertex, "x", "date", { shareScale: xEnc });
