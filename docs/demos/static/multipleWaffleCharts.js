...
msc.classify(c, {attribute: "Continent", layout: msc.layout("grid", {numCols: 6, rowGap: 2, colGap: 2, start: "bottomRight", direction: "rowFirst"})});
c.layout = msc.layout("grid", {numRows: 1, colGap: 30});
msc.encode(rect, "fillColor", "Life expectancy group", {mapping: {"below60": "#EEBC41", "above60": "#ABC88D"}});
