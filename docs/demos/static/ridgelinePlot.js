...
let data = scene.derive(csv, msc.transform("kde", {attribute: "Probability", newAttribute: "Probability_density", groupBy: ["Category"], min: -10, interval: 2.5, max: 150, bandwidth: 7}));
