...
The Glyph class represents a group of primitive [marks](../../marks/mark/). To create a glyph object, use the [_glyph_ method](../scene/#methods-create-mark-or-glyph) in the [Scene](../scene/) class.
