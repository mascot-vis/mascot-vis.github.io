...
The Group class represents a group of graphical objects (i.e., [marks](../../marks/mark/) or [groups](../group/)).

<!-- The group method has been removed from Scene.
To create a group, use the _group_ method in the [Scene](../scene/) class, for example:
