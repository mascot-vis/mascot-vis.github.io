...
You can also use the [_divide_ method](../../group/scene/#methods-join-graphics-with-data) in the [Scene](../../group/scene) class to transform a [Ring](../ringpath/) to a collection of Arc objects, or transform a [Circle](../circlepath/) to a collection of pie marks. [Here is an explanation](../../../tutorials/join/#divide) of the divide operation.
