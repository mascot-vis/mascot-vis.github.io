...
Mascot currently supports two kinds of constraints: [align and affix](../../docs/operations/create-element/). The _align_ constraint applies to an array of visual elements, and moves the elements so that their bounding boxes have the same value at a specified [anchor](../../docs/global/constants/#anchor). The figure below illustrates alignment constraints in the "y" direction with different anchor parameters.
