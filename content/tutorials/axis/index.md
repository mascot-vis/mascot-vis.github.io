...
The creation of gridlines is similar: we specify a visual channel and a data attribute when using the [_gridlines_ method in the Scene class](../../docs/group/scene/#methods-create-guides). The appearance of gridlines can be customized by setting [its properties](../../docs/guide/gridlines/#properties), such as the line definitions, stroke color, stroke width, stroke dash, opacity, and values.
